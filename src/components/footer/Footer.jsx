...
import footerimg from '../../assets/footertop.webp'
import olchaimg from '../../assets/olcha.png'
import './Footer.css'
      ...
      <div className="footer-wrap">
        <div className="footer-top">
            <div className="footer-top-text">
                ...
                <div className="footer-top-icons">
                    <div className="icon"><img src={"https://olcha.uz/_nuxt/appstore.BZyLL41o.svg"} alt="" /></div>
                    <div className="icon"><img src={"https://olcha.uz/_nuxt/googleplay.CcPmyygm.svg"} alt="" /></div>
                    <div className="icon"><img src={"https://olcha.uz/_nuxt/app-gallery.5qhZx5qb.svg"} alt="" /></div>
                </div>
            </div>
        ...
        <div className="footer-bottom">
                ...
                <div className="service">
                    <img src={olchaimg} alt="" />
                    <p>Qo'llab-quvvatlash raqami</p>
                    <h2>+998 (71) 202 202 1</h2>
